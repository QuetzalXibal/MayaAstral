<?php
  ...
  if (isset($_SESSION['registro_idregistro'])) {
    $records = $conn->prepare('SELECT idregistro, correo, passw FROM registro WHERE idregistro = :idregistro');
    $records->bindParam(':idregistro', $_SESSION['registro_idregistro']);
    $records->execute();
...
<html>
	...
	<?php else: ?>
      ...
      <a href="CerrarSesion.php">Crear Cuenta</a>
    <?php endif; ?>		 
    </body>
</html>
